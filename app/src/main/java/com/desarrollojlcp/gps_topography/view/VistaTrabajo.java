package com.desarrollojlcp.gps_topography.view;
...
public class VistaTrabajo extends View implements View.OnTouchListener {
    ...
    public float displayScale = 4.0f;
    public float xCen = 125;
    public float yCen = 900;
    ...
    public void actualizarVistaTrabajo(Poligono poligono){
                ...
                if (estTemp.ultimoPunto) {
                    ...
                    if(estTemp.radiaciones.size()>0){
                            for (int j = 0; j < estTemp.radiaciones.size(); j++){
                                ...
                                dibujarNodo(canvas,radiacion.idEst,cXr,cYr,(float) radiacion.xt,(float)radiacion.yt, radiacion.isPartePoligonoFinal());
            ...
            for (int i = 0; i < poligonoTrabajo.estaciones.size(); i++){
                ...
                if (estacion1.radiaciones.size()>0){
                    for (int j = 0; j < estacion1.radiaciones.size(); j++){
                        ...
                        if (estacion1.isPartePoligonoFinal() && radiacion.isPartePoligonoFinal()){
    ...
    public void dibujarLibreta (Canvas canvas){
        ...
        if (poligonoTrabajo.estaciones.size()>0){
            if (poligonoTrabajo.estaciones.elementAt(0).isPartePoligonoFinal()){
                paint.setColor(Color.BLACK);
            } else {
                paint.setColor(Color.BLUE);
            }
        ...
        if (poligonoTrabajo.estaciones.size() > 1){
            for (int i = 0; i < poligonoTrabajo.estaciones.size(); i++){
                if (i == 0){
                    ...
                    if (estacion1.isPartePoligonoFinal() && estacion2.isPartePoligonoFinal()){
                        dibujarElemento(canvas,cXN,cYN,cXF,cYF, Color.RED);
                    }else {
