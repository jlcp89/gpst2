...
public class Ingreso2 extends AppCompatActivity implements View.OnClickListener {
                ...
                try {
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            poligonoActual.estaciones.elementAt(0).partePoligonoFinal  = true;
                    ...
                    builder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                        ...
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            poligonoActual.estaciones.elementAt(0).partePoligonoFinal  = false;
                            vistaTrabajo.actualizarVistaTrabajo(poligonoActual);
                            dialog.dismiss();
                        }
                    });
    ...
    public void calcular(){
        ...
        poligonoActual.calcularPerimetro2();
        areaP = poligonoActual.area;
        perimetroP = poligonoActual.sumaDist;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void generarPDF(String rutaCarpetaProyectoActual) {
        ...
        encabezado = poligonoActual.proyecto + " " + poligonoActual.fecha;
        try {
    ...
    private PdfPTable generarTablaDatos(float anchoPag) {
        ...
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cell = new PdfPCell(new Phrase(poligonoActual.fecha));
        cell.setColspan(4);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        ...
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cell = new PdfPCell(new Phrase(poligonoActual.proyecto));
        cell.setColspan(4);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
    ...
    private PdfPTable generarTablaError(float anchoPag) {
        ...
        cadTemp = df.format(poligonoActual.sumaNortes);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.sumaSures);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.sumaEstes);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.sumaOestes);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        ...
        cadTemp = df.format(poligonoActual.deltaY);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(4);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.deltaX);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(4);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.sumaDist);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(4);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        ...
        cadTemp = df.format(poligonoActual.errC);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.errCierreUn);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.Cy);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
        cadTemp = df.format(poligonoActual.Cx);
        cell = new PdfPCell(new Phrase(cadTemp));
        cell.setColspan(3);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
    ...
    private PdfPTable generarTabla5(float anchoPag) {
        ...
        fuente.setSize(7);
        cadTemp = df.format(poligonoActual.sumaYX);
        cell = new PdfPCell(new Phrase(cadTemp,fuente));
        cell.setColspan(2);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);

        cadTemp = df.format(poligonoActual.sumaXY);
        cell = new PdfPCell(new Phrase(cadTemp,fuente));
        cell.setColspan(2);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        tabla1.addCell(cell);
