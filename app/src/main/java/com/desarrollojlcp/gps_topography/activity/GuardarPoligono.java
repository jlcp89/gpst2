...
public class GuardarPoligono extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textFecha.setText(poligonoActual.getFecha());
        ...
        botonGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                poligonoActual.setProyecto(editProyecto.getText().toString());
                ...
                if (poligonoActual.gettPol() == 0){
                    ...
                    if (poligonoActual.estaciones.size()>0){
                        ...
                        valuesPoligono.put(Utilidades.PoligonoEntry.CAMPO_FECHA, poligonoActual.getFecha());
                        valuesPoligono.put(Utilidades.PoligonoEntry.CAMPO_TIPO_POL, 0);
                        valuesPoligono.put(Utilidades.PoligonoEntry.CAMPO_PROYECTO, poligonoActual.getProyecto());
                        ...
                        valuesPoligono.put(Utilidades.PoligonoEntry.CAMPO_TIPO_MEDICION, poligonoActual.getTipoMedicion());
                        ...
                        for (int F = 0; F < poligonoActual.estaciones.size(); F++) {
                            ...
                            valuesEstacion.put(Utilidades.EstacionEntry.CAMPO_LAT, poligonoActual.estaciones.elementAt(F).getLat());
                            valuesEstacion.put(Utilidades.EstacionEntry.CAMPO_LON, poligonoActual.estaciones.elementAt(F).getLon());
                            valuesEstacion.put(Utilidades.EstacionEntry.CAMPO_OBSERVACIONES, poligonoActual.estaciones.elementAt(F).getObservaciones());
                            valuesEstacion.put(Utilidades.EstacionEntry.CAMPO_ALT, poligonoActual.estaciones.elementAt(F).getAlt());
                ...
                } else if (poligonoActual.gettPol() == 1){
                    long newPolId = 0;
                    if (poligonoActual.estaciones.size()>0){
